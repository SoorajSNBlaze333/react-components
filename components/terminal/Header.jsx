  ...
  const renderIcons = () => {
    return (
      <div className="h-full w-full flex items-center justify-evenly">
        <p className="rounded-full h-3 w-3 bg-red-400 ring-1 ring-gray-500 ring-opacity-65 cursor-pointer"></p>
        <p className="rounded-full h-3 w-3 bg-yellow-400 ring-1 ring-gray-500 ring-opacity-65 cursor-pointer"></p>
        <p className="rounded-full h-3 w-3 bg-green-400 ring-1 ring-gray-500 ring-opacity-65 cursor-pointer"></p>
      </div>
    );
  }

  return (
    <div style={{ height: '60px' }} className="w-full bg-gray-600 border-b border-gray-700 top-0 sticky font-semibold">
