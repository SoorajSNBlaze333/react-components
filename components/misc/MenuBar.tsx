...
const MenuDropdown = () => (
  <Menu as="div" className="relative inline-block cursor-pointer">
    <Menu.Button className="inline-flex m-0 focus:outline-none">
      S
    </Menu.Button>
    <Transition
      as={Fragment}
    ...
    >
      <Menu.Items as="div" className="absolute bg-gray-700 h-auto w-60 top-6 -left-1 z-10 outline-none ring-1 ring-gray-500 rounded-md text-white">
        <Menu.Item as="div" className="p-1" onClick={() => EventEmitter.dispatch('execCommand', { command: 'about', index: 0 })}>{(props) => <MenuButton { ...props }>Sooraj</MenuButton>}</Menu.Item>
